  ...
  factory UserSubscriptionMeData.fromJson(Map<String, dynamic> json) {
    return UserSubscriptionMeData(
      ...
      pendingPlan: json['pending_plan'] is Map<String, dynamic>
          ? UserSubscriptionPlanInfo.fromJson(
              json['pending_plan'] as Map<String, dynamic>,
            )
          : json['pendingPlan'] is Map<String, dynamic>
              ...
              : null,
      pendingEffectiveAt: json['pending_effective_at']?.toString() ??
          json['pendingEffectiveAt']?.toString(),
...
class UserSubscriptionUsage {
  ...
  UserSubscriptionUsage({
    this.diagnosisScansUsed,
    this.landscapeGensUsed,
  });

  factory UserSubscriptionUsage.fromJson(Map<String, dynamic> json) {
    return UserSubscriptionUsage(
      diagnosisScansUsed: _asInt(
        json['diagnosis_scans_used'] ?? json['diagnosisScansUsed'],
      ),
      landscapeGensUsed: _asInt(
        json['landscape_gens_used'] ?? json['landscapeGensUsed'],
      ),
    );
  }
