...
class ProfileIconLayout extends GetWidget<SettingsViewModel> {
  const ProfileIconLayout({super.key, this.isProfileEditable = false,required this.isEnableEditable,this.onClickEditPencil,required this. title});
  final String title;
              ...
              child: Stack(
                ...
                children: [
                  ...
                  Stack(
                   ...
                   (   isEnableEditable == true) ?  Positioned(bottom: 0,right: 0,child: IgnorePointer(
                    ...
                    child: CommonClickWidget(
                      onTap: () => onClickEditPencil?.call(),
                        child: Container(
                            ...
                            child: Image.asset(AppAssets.editPencilIc,width: 20.w,height: 20.w,))),
                  )):const SizedBox()
                    ],
                  ),
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    isEnableEditable == true? Row(children: [
                      SizedBox(width: 5.w,),
                      Image.asset(
