...
// ---------------------------------------------------------------------------
// LandscapeDesignLoadingView
// ---------------------------------------------------------------------------
class LandscapeDesignLoadingView extends StatefulWidget {
  ...
  const LandscapeDesignLoadingView({
    super.key,
    this.imageFile,
  ...
  @override
  State<LandscapeDesignLoadingView> createState() =>
      _LandscapeDesignLoadingViewState();
}

class _LandscapeDesignLoadingViewState extends State<LandscapeDesignLoadingView>
  ...
  @override
  void didUpdateWidget(LandscapeDesignLoadingView oldWidget) {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        SizedBox(height: 6.h),
        Text(
          'Please wait while we generate your garden design',
          textAlign: TextAlign.center,
          style: TextStyle(
            fontSize: 12.sp,
...
// ---------------------------------------------------------------------------
// Blinking dot (used in "Designing" badge)
// ---------------------------------------------------------------------------
