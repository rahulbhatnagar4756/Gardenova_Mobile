...
// ---------------------------------------------------------------------------
// LandscapeDesignProcessingView
// ---------------------------------------------------------------------------
class LandscapeDesignProcessingView extends StatefulWidget {
  ...
  const LandscapeDesignProcessingView({
    super.key,
    this.imageFile,
  ...
  @override
  State<LandscapeDesignProcessingView> createState() =>
      _LandscapeDesignProcessingViewState();
}

class _LandscapeDesignProcessingViewState
    extends State<LandscapeDesignProcessingView>
  ...
  @override
  void didUpdateWidget(LandscapeDesignProcessingView oldWidget) {
  ...
  void _fastForwardNext() {
    ...
    if (_currentStageIndex < _stages.length - 1) {
      ...
      if (_progressController.isAnimating) {
        _progressController.forward().whenComplete(callComplete);
      } else {
        callComplete();
      }
    }
              ...
              Expanded(
                child: Padding(
                  padding: EdgeInsets.symmetric(
                    horizontal: spacerSize20.w,
                    vertical: spacerSize16.h,
                  ),
                  child: Column(
                    children: [
                      // Stage dots
                      ...
                      SizedBox(height: spacerSize20.h),
    ...
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          ...
          // "Regenerating..." badge top-right
          Positioned(
            top: 30.h,
            right: 14.w,
            child: Container(
              padding: EdgeInsets.symmetric(
                horizontal: spacerSize10.w,
                vertical: spacerSize6.h,
              ),
              decoration: BoxDecoration(
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        SizedBox(height: 6.h),
        Text(
          'Please wait while we regenerate your new garden design',
          textAlign: TextAlign.center,
          style: TextStyle(
            fontSize: 12.sp,
...
// ---------------------------------------------------------------------------
// Blinking dot (used in "Regenerating" badge)
// ---------------------------------------------------------------------------
